...
<body class="bg-slate-100 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-600 mt-2">Enter your details below and choose how much you'd like to pay via M-Pesa.</p>
        </div>
        ...
        <form action="{{ route('register.adult.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="location" value="{{ old('location') }}" class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 outline-none transition text-sm" placeholder="e.g. Nyeri Town">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="file" name="image" accept="image/*" class="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 outline-none transition text-sm file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="club" required class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 outline-none transition text-sm">
            ...
            <div>
                ...
                <div class="bg-red-50 border border-red-200 rounded-xl p-5 mb-4">
                    ...
                    <div class="mt-3">
                        <label class="block text-sm font-medium text-slate-700 mb-1">Amount to Pay (KSH) <span class="text-red-500">*</span></label>
                        <input type="number" name="amount" value="{{ old('amount', 1000) }}" min="100" step="100" required class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 outline-none transition text-sm" placeholder="e.g. 1000">
                        <p class="text-xs text-slate-500 mt-1">Enter the amount you wish to pay. Minimum KSH 100.</p>
                    </div>
                </div>
                <div>
